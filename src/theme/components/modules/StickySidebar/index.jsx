              ...
              <div className={Styles.right_container}>
                <div className={Styles.right_container_inner}>
                  <div className={Styles.button_content}>
                    {showButton && (
                      <div className={`${Styles.button_wrapper} wow animate__animated animate__zoomIn`}>
                        <Button
                  ...
                  <div className={Styles.icon_text_container}>
                    ...
                    >
                      ...
                      <div className={Styles.text}>
                        <a href={phone_number_link.href_with_scheme || '#'}>{phone_number}</a>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className={Styles.text}>
                        <a
                          href={email_link?.url?.href_with_scheme || '#'}
                          target={
                    ...
                    >
                      ...
                      <div className={Styles.text}>
                        <a
                          href={social_link?.url?.href_with_scheme || '#'}
                          target={
